...
export type { CourseCertificate } from "./contracts/CourseCertificate";
export { CourseCertificate__factory } from "./factories/contracts/CourseCertificate__factory";
...
export type { YiDengToken } from "./contracts/YiDengToken";
export { YiDengToken__factory } from "./factories/contracts/YiDengToken__factory";
