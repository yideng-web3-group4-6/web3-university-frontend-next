        ...
        <Box className='w-full md:mt-10 md:mb-30'>
            <Box className='mx-auto' maxWidth="md">
                <Box className="email-area text-center active-shape hover-shape-inner">
                    <h2 className="title mb-8 text-xl font-bold">
                    ...
                    <div className="flex items-center justify-center gap-2">
                        ...
                        />
                        <button className="md:h-11 rounded-md bg-[#A3FF12] px-3 py-2 cursor-pointer">
                            <span className="text-black text-bold">Contact</span>
