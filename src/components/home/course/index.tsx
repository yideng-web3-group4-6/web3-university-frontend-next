  ...
  return (
    <Box className='w-full py-6 md:mt-30 md:mb-30'>
      <Container maxWidth="lg">        
        <h1 className='mb-2 font-bold text-4xl text-[#A3FF12]'>
         Popular Course
        </h1>
          ...
          {courseList.map((item, index) => (
            ...
            >
              <a className='h-fit w-full'>
                ...
                <div className='aspect-[3/2] w-full overflow-hidden rounded-3xl' style={{backgroundColor: item.bgColor}}>
                  <img src={item.image} alt='image' className='aspect-[3/2] w-full object-cover transition duration-300 group-hover:scale-[1.015]' />
                </div>
              </span>
              <span>
        ...
        <div className='flex justify-center'>
          <a href="/course" className='cursor-pointer w-fit rounded-full bg-[#B5FF6D]/10 px-4 py-2'>View All Course</a>
        </div>
      </Container>
    </Box>
  );
