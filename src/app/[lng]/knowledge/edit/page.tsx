        ...
        >
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                type="text"
                className="w-full bg-dark-input border border-[#00f3ff]/30 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-[#00f3ff]"
              ...
              {({ open }) => (
                <div className="border border-[#00f3ff]/30 rounded-lg">
                  <Disclosure.Button className="flex justify-between w-full px-4 py-2 bg-dark-card/50">
                    <span className="text-[#00f3ff] text-sm font-medium">
                      高级设置
                    </span>
                    <ChevronUp
                      className={`${
                  ...
                  <Disclosure.Panel className="px-4 py-6 space-y-6 bg-dark-card/20">
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        className="w-full bg-dark-input border border-[#00f3ff]/30 rounded-lg px-4 py-2 text-white"
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <label
                          ...
                          className="cursor-pointer bg-dark-card border border-[#00f3ff]/30 px-4 py-2 rounded-lg text-sm hover:shadow-neon transition-all"
                        >
                          选择文件
                        </label>
                        {formData.cover && (
